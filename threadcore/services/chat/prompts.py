...
or requires specific context, documents, videos, transcripts, or recent information ("rag").

Rules:
- Return "chat" for greetings, personal questions, opinions, or general knowledge.
- Return "rag" for questions about specific uploaded content or recent information.
...
Given the following user message, create a short title that captures the conversation.
