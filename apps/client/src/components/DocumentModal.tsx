...
const DocumentModal = ({ isSubmitting, onClose, onSubmit }: DocumentModalProps) => {
    ...
    <div className="flex max-h-[calc(100vh-4rem)] w-full flex-col gap-6 overflow-y-auto rounded-2xl bg-white p-5 shadow-2xl sm:p-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Upload a PDF or document file to parse and extract text.
        </p>
      </div>
      ...
      >
        {file ? file.name : "Choose a document file"}
      </button>
